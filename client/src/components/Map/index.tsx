...
const Minimap = React.forwardRef<HTMLDivElement, IMapProps>(
  (
    {
      info,
      children,
    ...
    const [mapPosition, setMapPosition] = React.useState<CoordinatesType>([
      0, 0,
    ]);
    const [mapCursor, setMapCursor] = React.useState<MapCursors>(
      MapCursors.AUTO
    );
